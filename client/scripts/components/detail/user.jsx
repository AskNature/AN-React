  ...
  render: function() {
    ...
    return (
        ...
        <DefaultLayout>
          ...
          <SubHero description={detail.special_text} editable={this.state.editable} store={focusStore} actions={focusActions} editBegin={this.editBegin} editFinish={this.editFinish} editCancel={this.editCancel} entityname={entityName}/>
