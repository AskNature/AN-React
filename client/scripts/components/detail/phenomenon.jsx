...
var DetailComponent = React.createClass({
  ...
  render: function() {
    ...
    var legacy_url = 'http://www.asknature.org/explore/'+detail.masterid;
    return (
        /* jshint ignore:start */
        <DefaultLayout>
            <Grid>
              <Row className="show-grid">
                <Col xs={12} md={12}>
                  <ButtonToolbar>
                    <Link url="../admin/phenomena"><Button><Glyphicon glyph="chevron-left" /> Strategy Console</Button></Link>
