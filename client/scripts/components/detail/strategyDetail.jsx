        ...
        return (
		    ...
		    <Grid>
          	        <Row className='show-grid'>
            		    ...
            		    <Col xs={6} sm={4}>
                            <RelationshipList items={this.state.object.mechanisms} editable={this.state.editable} titleField='name' onAdd={this.onRelationshipAdd.bind(null,'mechanisms')} onRemove={this.onRelationshipRemove.bind(null, 'mechanisms')} field={'functions'} routeName={'FM'} title={'Mechanisms'} fieldName={'Mechanisms'}/>
            		    </Col>
            		    <Col xs={6} sm={4}>
                          <RelationshipList items={this.state.object.functions} editable={this.state.editable} titleField='name' onAdd={this.onRelationshipAdd.bind(null, 'functions')} onRemove={this.onRelationshipRemove.bind(null, 'functions')} field={'functions'} routeName={'FM'} title={'Outcomes'} fieldName={'Outcomes'}/>
            		    </Col>
          		</Row>
         	    </Grid>
                    	    <Grid>
