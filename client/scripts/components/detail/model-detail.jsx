    ...
    return (
      ...
      <div>
        ...
        <SubHero
          ...
          descriptionlink={detail.company_website}
          editable={this.state.editable}
          store={store}
          actions={actions}
        ...
        <Grid>
          <Row className='show-grid'>
            <Col xs={12} sm={4}>
              <RelationshipList
                items={detail.designedsystems}
                editable={this.state.editable}
                onAdd={this.onRelationshipAdd.bind(null, 'designedsystems')}
                onRemove={this.onRelationshipRemove.bind(null, 'designedsystems')}
              ...
              <RelationshipList
                ...
                editable={this.state.editable}
                onAdd={this.onRelationshipAdd.bind(null, 'conditions')}
                onRemove={this.onRelationshipRemove.bind(null, 'conditions')}
                field={'conditions'}
                routeName='condition'
                title='Context'
                fieldName='Context'
            ...
            <Col xs={6} sm={4}>
              <RelationshipList
                items={detail.mechanisms}
                editable={this.state.editable}
                onAdd={this.onRelationshipAdd.bind(null, 'mechanisms')}
                onRemove={this.onRelationshipRemove.bind(null, 'mechanisms')}
                field={'mechanisms'}
            ...
            <Col xs={6} sm={4}>
              <RelationshipList
                ...
                editable={this.state.editable}
                onAdd={this.onRelationshipAdd.bind(null, 'outcomes')}
                onRemove={this.onRelationshipRemove.bind(null, 'outcomes')}
                field={'outcomes'}
                routeName='phenomenon'
                title='Outcomes'
                fieldName='Outcome'
            ...
            <Col xs={12} sm={8}>
              <RelationshipList
                items={detail.strategies}
                editable={this.state.editable}
                onAdd={this.onRelationshipAdd.bind(null, 'strategies')}
                onRemove={this.onRelationshipRemove.bind(null, 'strategies')}
                field={'strategies'}
                routeName='strategy'
                title='Inspired By'
            ...
            <Col xs={12} md={12}>
              ...
              {detail.how_is_it_different || this.state.editable ? (
                <TextArea
                  ...
                  item={detail.how_is_it_different}
                  store={store}
                  actions={actions}
