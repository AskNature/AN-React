...
var focusStore = require('../../stores/detail/collections');

/** Sends outgoing requests to an action */

var focusActions = require('../../actions/collections');
...
var StrategyDetail = React.createClass({
  ...
  render: function() {
    ...
    var legacy_url = 'http://www.asknature.org/collections/'+detail.masterid;
    return (
        /* jshint ignore:start */
        <DefaultLayout>
            <Grid>
              <Row className="show-grid">
                <Col xs={12} md={12}>
                  <ButtonToolbar>
                    <Link url="../admin/collections"><Button><Glyphicon glyph="chevron-left" /> Collections Console</Button></Link>
