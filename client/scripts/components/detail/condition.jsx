...
var focusStore = require('../../stores/detail/conditions');

/** Sends outgoing requests to an action */

var focusActions = require('../../actions/conditions');
        ...
        <DefaultLayout>
            <Grid>
              <Row className="show-grid">
                <Col xs={12} md={12}>
                  <ButtonToolbar>
                    <Link url="../admin/conditions"><Button><Glyphicon glyph="chevron-left" /> Challenges Console</Button></Link>
                  </ButtonToolbar>
                </Col>
              </Row>
              <Row className="show-grid">
