		...
		<ListGroup>
		    {
		        this.props.items.map(function(item) {
	            	    return <RelationshipListItem item={item} routeName={this.props.field} key={item.masterid} />;
			}, this)
		    }
		    {
			this.props.editable ? <RelationshipListItemInput editable={this.props.editable} fieldName={this.props.fieldName} field={this.props.field} onAdd={this.onAdd} onRemove={this.onRemove} /> : ""
		    }
		</ListGroup>
	    </div>
	);
