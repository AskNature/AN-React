...
var Constants = require('../constants/source');
var Defaults = require('../constants/defaults').source;
...
module.exports = {
  ...
  */
  ...
  setList: function(focus) {
    Dispatcher.handleViewAction({
      actionType: Constants.GET_ALL_SOURCES,
  ...
  */
  ...
  setItem: function(focus, next) {
    Dispatcher.handleViewAction({
      actionType: Constants.GET_SOURCE,
      focus: assign({}, Defaults, focus)
    });
