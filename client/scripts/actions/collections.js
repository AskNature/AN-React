...
var Constants = require('../constants/collection');
var Defaults = require('../constants/defaults').collection;
...
module.exports = {
  ...
  */
  ...
  setList: function(focus) {
    Dispatcher.handleViewAction({
      actionType: Constants.GET_ALL_COLLECTIONS,
  ...
  */
  ...
  setItem: function(focus, next) {
    Dispatcher.handleViewAction({
      actionType: Constants.GET_COLLECTION,
      focus: assign({}, Defaults, focus)
    });
