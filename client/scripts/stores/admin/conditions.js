...
var focusConstants = require('../../constants/condition');

/** Gets default values to be used until db action is completed */
var focusDefaults = require('../../constants/defaults').condition;
...
FocusStore.dispatcherToken = Dispatcher.register(function(payload) {
  ...
  if (action.actionType === focusConstants.GET_ALL_CONDITIONS) {
    _focus = action.focus;
