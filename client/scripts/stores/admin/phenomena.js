...
var focusConstants = require('../../constants/phenomenon');

/** Gets default values to be used until db action is completed */
var focusDefaults = require('../../constants/defaults').phenomenon;
...
FocusStore.dispatcherToken = Dispatcher.register(function(payload) {
  ...
  if (action.actionType === focusConstants.GET_ALL_PHENOMENA) {
    _focus = action.focus;
