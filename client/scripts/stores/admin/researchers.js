...
var focusConstants = require('../../constants/researcher');

/** Gets default values to be used until db action is completed */
var focusDefaults = require('../../constants/defaults').researcher;
...
FocusStore.dispatcherToken = Dispatcher.register(function(payload) {
  ...
  if (action.actionType === focusConstants.GET_ALL_RESEARCHERS) {
    _focus = action.focus;
