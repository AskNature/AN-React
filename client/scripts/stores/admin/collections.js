...
var focusConstants = require('../../constants/collection');

/** Gets default values to be used until db action is completed */
var focusDefaults = require('../../constants/defaults').collection;
...
FocusStore.dispatcherToken = Dispatcher.register(function(payload) {
  ...
  if (action.actionType === focusConstants.GET_ALL_COLLECTIONS) {
    _focus = action.focus;
